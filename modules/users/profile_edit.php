	...
	<form id="userRegistration" name="userRegistration" method="post" action="" onsubmit="mbmCheckForm();return false;">
	  ...
	  <table width="100%" border="0" cellspacing="2" cellpadding="3">
		...
		<tr>
          ...
          <td align="right">Нууц үгээ дахин оруул:</td>
		...
		<tr>
		  ...
		  <td align="right">Төрсөн огноо:</td>
		...
		<tr>
		  ...
		  <td width="20%" align="right">Имэйл:</td>
		...
		<tr>
		  ...
		  <td><input type="submit" class="button" name="userRegistration" id="userRegistration" value="Хадгалах" /></td>
