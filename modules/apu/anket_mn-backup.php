...
if(isset($_POST['a'])){
	$email_con = '<table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				';
	//mail('m.batmunkh@yahoo.com','dddd','eeeee');
...
//	$PHPMAILER->From = $_POST['a6'];
	...
	if(!$PHPMAILER->Send()){
		$result_txt = 'Илгээх явцад алдаа гарлаа дахин оролдоно уу.';
	}else{
		$b = 1;
		$result_txt = 'Таны анкетийг илгээлээ.';
	}
