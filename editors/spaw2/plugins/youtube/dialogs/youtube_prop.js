...
SpawYouTubePropDialog.init = function() 
{
  ...
  if (iProps)
  {
    if (iProps.src && iProps.src.indexOf("youtube")) {
      ...
      document.getElementById('csrc').value = "http://www.youtube.com/watch?v=" + fl_url;
    }
  }
...
SpawYouTubePropDialog.okClick = function() {
  ...
  if (SpawYouTubePropDialog.validateParams())    
  {
    ...
    iProps.setAttribute("width","425");
    iProps.setAttribute("height","350");
    iProps.setAttribute("wmode","transparent");
