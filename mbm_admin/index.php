  ...
  <tr>
    <td height="38" bgcolor="#265CA6" style="background-image:url(images/header_blue.jpg);
                            ...
                            <div style="float:right; margin:5px;">
                           	<a href="index.php?lang=mn" style="color:#FFFFFF;">Mongolian</a> | <a href="index.php?action=lang&amp;lang=en" style="color:#FFFFFF;">English</a>                            </div>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
			...
			if(file_exists(ABS_DIR.INCLUDE_DIR."mbm_admin/modules/".$_GET['module']."/".$_GET['cmd'].".php")){
				if($_SESSION['lev']>=$modules_permissions[$_GET['module']] && isset($modules_permissions[$_GET['module']])){
					if($DB2->mbm_get_field($_SESSION['user_id'],'id','lev','users')>=$modules_permissions[$_GET['module']]){
